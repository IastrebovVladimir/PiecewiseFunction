...
Проект реализует обобщённый класс PiecewiseFunction<T>, который хранит функцию как набор отрезков (Segment<T>) с собственными функциями на каждом интервале.
